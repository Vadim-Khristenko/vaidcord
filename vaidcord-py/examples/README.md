...
For text-channel examples, invite the bot with at least `View Channel`, `Send Messages`, and `Read Message History`. Examples that send embeds, polls, manage messages, or work in threads need their matching Discord permissions as well.
